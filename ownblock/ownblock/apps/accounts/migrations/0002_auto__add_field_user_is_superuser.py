...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('accounts_user', 'is_superuser',
    ...
    def backwards(self, orm):
        ...
        db.delete_column('accounts_user', 'is_superuser')
    ...
    models = {
        'accounts.user': {
            ...
            'organization': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'to': "orm['organizations.Organization']", 'null': 'True'}),
