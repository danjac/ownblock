...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Contact.available_hours'
        db.add_column('contacts_contact', 'available_hours',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Contact.available_hours'
        db.delete_column('contacts_contact', 'available_hours')
    ...
    models = {
        ...
        'contacts.contact': {
            ...
            'available_hours': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
