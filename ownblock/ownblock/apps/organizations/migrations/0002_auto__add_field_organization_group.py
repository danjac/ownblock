...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('organizations_organization', 'group',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, to=orm['auth.Group'], null=True),
                      keep_default=False)
    ...
    models = {
        ...
        'organizations.organization': {
            ...
            'group': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'to': "orm['auth.Group']", 'null': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
